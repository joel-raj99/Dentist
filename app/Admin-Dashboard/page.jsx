...
// //             <p className="leading-tight text-white capitalize">Total Appointments</p>
// //             <div className="flex items-center justify-between mb-2">
// //               <AnimatedValue start={0} end={200} duration={2000} />
// //               <RadialProgress targetValue={70} />
// //             </div>
...
// //             </div>
// //             <div className="mt-0 mb-6 card-actions">
// //               <p className="mb-8 text-xs font-bold leading-tight text-white">Total Doctors for 400</p>
// //             </div>
// //           </div>
// //         </div>
...
// //             </div>
// //             <div className="mt-0 mb-6 card-actions">
// //               <p className="mb-8 text-xs font-bold leading-tight text-white">Total Patients for 400</p>
// //             </div>
// //           </div>
// //         </div>
...
//       try {
//         const response = await axios.get('/api/Dentist'); // Assuming this returns the list of dentists
//         setTotalDentists(response.data.length); // Setting the total count
//       } catch (error) {
//         console.error("Error fetching dentist count:", error);
//       }
//     };
//     fetchDentistCount();
//   }, []);
...
//             <p className="leading-tight text-white capitalize">Total Doctors</p>
//             <div className="flex items-center justify-between mb-2">
//               <AnimatedValue start={0} end={totalDentists} duration={2000} />
//               <RadialProgress targetValue={totalDentists / 4} />
//             </div>
//             <div className="mt-0 mb-6 card-actions">
//               <p className="mb-8 text-xs font-bold leading-tight text-white">Total Doctors for {totalDentists}</p>
//             </div>
//           </div>
//         </div>
  ...
  useEffect(() => {
    const fetchCounts = async () => {
      try {
        ...
        setTotalDentists(dentistsResponse.data.length);
      ...
      <div className="grid grid-cols-3 gap-12">
        <div className="bg-blue-800 rounded-lg shadow-xl card w-80 h-44">
          <div className="p-4 card-body">
            <p className="leading-tight text-white capitalize">Total Appointments</p>
            <div className="flex items-center justify-between mb-2">
              <AnimatedValue start={0} end={totalAppointments} duration={2000} />
              <RadialProgress targetValue={(totalAppointments / 4)} />
            </div>
            <div className="mt-0 mb-6 card-actions">
        ...
        <div className="bg-blue-800 rounded-lg shadow-xl card w-80 h-44">
          <div className="p-4 card-body">
            <p className="leading-tight text-white capitalize">Total Patients</p>
            <div className="flex items-center justify-between mb-2">
              <AnimatedValue start={0} end={totalPatients} duration={2000} />
              <RadialProgress targetValue={(totalPatients / 4)} />
            </div>
            <div className="mt-0 mb-6 card-actions">
